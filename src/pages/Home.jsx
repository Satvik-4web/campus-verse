  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 className="text-center font-black tracking-[0.15em] select-none leading-[0.8] text-transparent bg-clip-text bg-gradient-to-b from-sky-400/45 via-sky-500/25 to-sky-600/10 drop-shadow-[0_0_45px_rgba(56,189,248,0.18)] w-full overflow-visible transform portrait:text-[25vw] landscape:text-[13vw]">
          CAMPUS<br/>VERSE
        </h1>
      </motion.div>
