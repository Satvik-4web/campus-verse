  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 className="flex flex-col items-center portrait:justify-start portrait:pt-[15vh] landscape:justify-center font-black tracking-[0.15em] select-none leading-[0.8] text-transparent bg-clip-text bg-gradient-to-b from-sky-400/45 via-sky-500/25 to-sky-600/10 drop-shadow-[0_0_45px_rgba(56,189,248,0.18)] w-full overflow-visible transform landscape:scale-x-100 h-full">
          <span className="portrait:text-[20vw] landscape:text-[13vw] pl-[0.15em] text-center w-full whitespace-nowrap">CAMPUS</span>
          <span className="portrait:text-[20vw] landscape:text-[13vw] pl-[0.15em] text-center w-full whitespace-nowrap">VERSE</span>
        </h1>
      </motion.div>
